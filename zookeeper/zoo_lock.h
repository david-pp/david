 ...
 */
 int zkr_lock_init(zkr_lock_mutex_t *mutex, zhandle_t* zh, 
 ...
 * \return return 0 if successful.
 */
 int zkr_lock_init_cb(zkr_lock_mutex_t *mutex, zhandle_t* zh,
                      char* path, struct ACL_vector *acl, 
 ...
 */
 int zkr_lock_lock(zkr_lock_mutex_t *mutex);
 ...
 */
 int zkr_lock_unlock(zkr_lock_mutex_t *mutex);
 ...
 */
 void zkr_lock_setcallback(zkr_lock_mutex_t *mutex, 
                           zkr_lock_completion completion);
 ...
 */
 zkr_lock_completion zkr_lock_getcallback(zkr_lock_mutex_t *mutex);
 ...
 */
 int zkr_lock_destroy(zkr_lock_mutex_t* mutex);
 ...
 */
 char* zkr_lock_getpath(zkr_lock_mutex_t *mutex);
 ...
 */
 int zkr_lock_isowner(zkr_lock_mutex_t *mutex);
 ...
 */
 char* zkr_lock_getid(zkr_lock_mutex_t *mutex);
